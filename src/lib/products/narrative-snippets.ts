  ...
  'build+web-management::*::*': (ctx) => {
    ...
    return {
      ...
      what_i_recommend_paragraphs: [
        ...
        `The reason to name the launch handoff in writing is the most common failure mode of a new site. The site is built. The project closes. A few months later nobody owns the upkeep. That is not this engagement. From the day the site goes live, the upkeep is mine, billed monthly, on a known number and a known cadence. Any additional builds inside the same engagement come at 10 percent off the first.`,
      ],
      rollout_phases: [
        {
          phase_num: 'Phase 1',
